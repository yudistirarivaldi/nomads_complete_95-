        ...
        <div class="card shadow">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="departure_date" placeholder="Title" value="{{ $item->departure_date }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="type" class="form-control" name="type" placeholder="Type" value="{{ $item->type }}">
                </div>
