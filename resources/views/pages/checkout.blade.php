            ...
            <div class="card card-details">
                    ...
                    <table class="table table-responsive-sm text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    {{ \Carbon\Carbon::createFromDate($detail->doe_password) > \Carbon\Carbon::now() ? 'Active' : 'Inactive' }}
                                </td>

                                <td class="align-middle">
                                     <a href="{{ route('checkout-remove', $detail->id) }}">
                                <img src="{{ url('frontend/images/remove.png') }}" alt=""></a>
                                </td>
                            </tr>
                            @empty
                                <tr>
                ...
                <div class="member mt-3">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        <input type="text" class="form-control datepicker" name="doe_password" 
                        id="doepassword" placeholder="DOE Passport">
